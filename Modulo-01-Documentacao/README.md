...
A equipe de TI da Lyon Company Maternidades precisa transformar o modelo lógico em um Dicionário de Dados, seguindo as boas práticas de normalização. Considerando o MER criado anteriormente, construa Dicionário de dados do banco utilizando o anexo “Modelo de Dicionário de Dados”, especificando:
- Nome das tabelas
